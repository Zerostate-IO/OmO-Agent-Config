        ...
        filtered = filtered.filter(model => {
            return filters.capabilities.every(cap => {
                switch (cap) {
                    ...
                    // Billing model filters
                    case 'sub':
                    case 'subscription': return model.billingModel === 'subscription';
                    case 'pay':
                    case 'metered': return model.billingModel === 'metered';
                    case 'free': return model.billingModel === 'free';
