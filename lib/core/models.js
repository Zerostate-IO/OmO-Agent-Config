...
const { CACHE_DIR, OPENCODE_CONFIG_FILE, PROVIDER_ALIASES, normalizeProviderName } = require('../constants');
...
function rankProvider(provider, model) {
  ...
  // Matches upstream priority: Native > Kimi > Copilot > Venice > OpenCode > Z.ai
  const providerTiers = {
    'anthropic': 1,        // Native - best
    'openai': 1,           // Native - best
    'google': 1,           // Native - best
    'kimi-for-coding': 2,  // Kimi for Coding
    'github-copilot': 3,   // GitHub Copilot
    'venice': 4,           // Venice
    'opencode': 5,         // OpenCode Zen
    'zai-coding-plan': 6   // Z.ai Coding Plan - worst
  };

  let score = 0;

  // Provider tier (dominant factor, 0-60 points)
  score += (providerTiers[normalizedProvider] || 10) * 10;
