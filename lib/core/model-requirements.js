 ...
 * Mirrors upstream oh-my-openagent model requirements
 * Dependency-free: Node built-ins only
 *
 * @upstream-url https://github.com/code-yeongyu/oh-my-openagent/blob/dev/packages/model-core/src/model-requirements.ts
 * @upstream-sha 0904e2378e1296ba3338dc055dbe6680cc802472
 */
...
function transformModelForProvider(provider, model) {
  if (provider === "github-copilot") {
    return model
      ...
      .replace("gemini-3.1-pro", "gemini-3.1-pro-preview")
